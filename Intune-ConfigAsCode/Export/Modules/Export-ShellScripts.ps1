function Export-ShellScripts {
    ...
    Write-Host "Exporting Shell Scripts..." -ForegroundColor Cyan

    $ExportPath = Join-Path $RepositoryRoot "ShellScripts"
    ...
    Write-Host ""
    Write-Host "Exported $Count Shell Script(s)." -ForegroundColor Green
    Write-Host ""
}